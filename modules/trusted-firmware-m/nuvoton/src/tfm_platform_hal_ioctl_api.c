...
{
	/* Invoke Platform IOCTL function */
	NVT_TFM_PLAT_IOCTL_CALL(FMC_Open, NULL, 0, NULL, 0);
}

void NVT_TFM_PLAT_IOCTL_NS(FMC_Close)(void)
{
	/* Invoke Platform IOCTL function */
	NVT_TFM_PLAT_IOCTL_CALL(FMC_Close, NULL, 0, NULL, 0);
}

void NVT_TFM_PLAT_IOCTL_NS(FMC_ENABLE_AP_UPDATE)(void)
{
	/* Invoke Platform IOCTL function */
	NVT_TFM_PLAT_IOCTL_CALL(FMC_ENABLE_AP_UPDATE, NULL, 0, NULL, 0);
}

void NVT_TFM_PLAT_IOCTL_NS(FMC_DISABLE_AP_UPDATE)(void)
{
	/* Invoke Platform IOCTL function */
	NVT_TFM_PLAT_IOCTL_CALL(FMC_DISABLE_AP_UPDATE, NULL, 0, NULL, 0);
}
