...
static nvt_plat_ioctl_srv_t nvt_plat_ioctl_srv_tab[] = {
	...
	/* BSP FMC driver API */
	NVT_TFM_PLAT_IOCTL_SRV(FMC_Open),
	NVT_TFM_PLAT_IOCTL_SRV(FMC_Close),
	NVT_TFM_PLAT_IOCTL_SRV(FMC_ENABLE_AP_UPDATE),
	NVT_TFM_PLAT_IOCTL_SRV(FMC_DISABLE_AP_UPDATE),
};
